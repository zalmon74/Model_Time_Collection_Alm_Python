...
from get_conf_paramets import get_conf_set_formation_ci
...
DIC_IND_STR_IN_IND_SIG_NOT_BEL = {
                                ...
                                DIC_NUM_STR_IN_IND[50]: [DIC_NAME_SIG_IN_IND["L3OC"], DIC_NAME_SIG_IN_IND["L1SC"],
                                                         DIC_NAME_SIG_IN_IND["L2SC"]]
                                 }
...
# Путь до файла, который содержит пути до конфигурационных файлов
PATH_TO_PATH_FILES = "../conf/paths.conf"
# Конфигурационные параметры для формирования ЦИ
SET_FORM_CI = get_conf_set_formation_ci("../conf/paths.conf")
