...
MIN_UM = 5
START_LATITUDE = -60 # Начало широты для моделирования в град.
END_LATITUDE   =  60 # Конец широты для моделирования в град.
STEP_LATITUDE  =  2 # Шаг по широте для моделирования в град.
START_LONGITUDE = -180 # Начало долготы для моделирования в град.
END_LONGITUDE   =  180 # Конец долготы для моделирования в град.
